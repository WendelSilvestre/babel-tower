export const newPhrases = [
    ...
    { "person": "Rebeca", "phrase": "Compra bem, trabalha tanto" },
...
export const oldPhrases = [
    { "person": "Wendel", "phrase": "Ok" },
    { "person": "Wendel", "phrase": "Basicamente" },
    { "person": "Wendel", "phrase": "Não fala isso não" },
    { "person": "Wendel", "phrase": "Vou comer seu olho!" },
    { "person": "Wendel", "phrase": "Por que você ta me perguntando isso?" },

    { "person": "Gaia", "phrase": "Éhh" },
    { "person": "Gaia", "phrase": "Tá lá" },
    { "person": "Gaia", "phrase": "Padaria?!" },
    { "person": "Gaia", "phrase": "Se ta putinho?" },
    { "person": "Gaia", "phrase": "Pair programming?" },
    ...
    { "person": "Massaru", "phrase": "BigSad" },
    { "person": "Massaru", "phrase": "GigaTrash" },
    { "person": "Massaru", "phrase": "Sacanagem" },
    { "person": "Massaru", "phrase": "É nada!!!" },
    { "person": "Massaru", "phrase": "O cara não dá a mínima" },
    { "person": "Massaru", "phrase": "Me sentindo meio homem fezes" },

    { "person": "Jojo", "phrase": "Eai, o senhor ta bem" },
    { "person": "Jojo", "phrase": "Chefe me tira uma dúvida" },
    { "person": "Jojo", "phrase": "Do time de core, você está entre os 3 melhores" },

    { "person": "Massu", "phrase": "É cíclico" },
    { "person": "Massu", "phrase": "É o merda do Bruneiji" },
    
    { "person": "Paulo", "phrase": "Não te contaram?" },
    { "person": "Paulo", "phrase": "Fica ai, vai ter pizza" },

    { "person": "Caue", "phrase": "Isso dai num CDB" },

    { "person": "PC", "phrase": "." },
    { "person": "PC", "phrase": "Pohaaa" },
    { "person": "PC", "phrase": "É O QUE!?" },
    { "person": "PC", "phrase": "É outras conversas" },

    { "person": "Xavier", "phrase": "Safe" },
    { "person": "Xavier", "phrase": "Ai é bad" },
    { "person": "Xavier", "phrase": "Faz Parte" },
    { "person": "Xavier", "phrase": "Aracaju? Sete pica no teu " },
    { "person": "Xavier", "phrase": "Da pra dale" },
    { "person": "Xavier", "phrase": "Poha é o c# da cachorra" },

    { "person": "Dotts", "phrase": "Boa" },
    { "person": "Dotts", "phrase": "Ô fí" },
    { "person": "Dotts", "phrase": "Safado" },
    { "person": "Dotts", "phrase": "É o Bregenelson" },
    { "person": "Dotts", "phrase": "Turn yourself, fí!" },
    { "person": "Dotts", "phrase": "Quer levar um socão" },
    { "person": "Dotts", "phrase": "Tem que criar caráter" },

    { "person": "Delson", "phrase": "First try!" },
    { "person": "Delson", "phrase": "É O WENDEL QUE FICA MUDANDO AS COISAS E NÃO AVISA" },
    { "person": "Delson", "phrase": "A chance é meio. Só que as vezes um meio é maior que o outro" },
]